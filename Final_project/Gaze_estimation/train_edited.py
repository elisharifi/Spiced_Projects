...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='/content/drive/MyDrive/L2CS-Net/Gaze_Estimation/datasets/MPIIFaceGaze/Image', type=str)
    parser.add_argument(
        '--gazeMpiilabel_dir', dest='gazeMpiilabel_dir', help='Directory path for gaze labels.',
        default='/content/drive/MyDrive/L2CS-Net/Gaze_Estimation/datasets/MPIIFaceGaze/Label', type=str)
    ...
    parser.add_argument(
        ...
        default='/content/drive/MyDrive/L2CS-Net/Gaze_Estimation/output/snapshots', type=str)
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    if data_set=="mpiigaze":
        ...
        for fold in range(15):
            ...
            train_loader_gaze = DataLoader(dataset=dataset,
            ...
            for epoch in range(num_epochs):
                ...
                for i, (images_gaze, labels_gaze, cont_labels_gaze,name) in enumerate(train_loader_gaze):
                    ...
                    if (i+1) % 100 == 0:
                        n = datetime.now()
                        hh, mm, ss = n.hour, n.minute, n.second
                      # y, m, d, h, min, sec, wd, yd, i = t
                        print('Epoch [%d/%d], Iter [%d/%d], Time [%s:%s:%s], Losses: '
